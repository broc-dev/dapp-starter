...
const Footer = () => {
    return(
        <div className="w-screen h-44 flex flex-col justify-center items-stretch bg-black flex-wrap md:flex-nowrap lg:px-52 md:px-32 sm:px-24 px-8">
                ...
                <div className="md:w-auto w-full h-auto p-4">
                    <div className="w-full h-full flex flex-row justify-between items-stretch">
                        <div className="w-36 flex flex-col justify-start mr-4">
                            <span className="block w-full text-zinc-400 f font-header text-lg">Pages</span>
                            <a className="text-xl text-zinc-600 font-pixel w-full hover:text-white" href="#">Trident Home</a>
                            <a className="text-xl text-zinc-600 font-pixel w-full hover:text-white" href="#">Twitter</a>
                            <a className="text-xl text-zinc-600 font-pixel w-full hover:text-white" href="#">Discord</a>
                        </div>
                        <div className="w-36 flex flex-col justify-start">
                            <span className="block w-full text-zinc-400 f font-header text-lg">More Info</span>
                            <a className="text-xl text-zinc-600 font-pixel w-full hover:text-white" href="#">Github</a>
                            <a className="text-xl text-zinc-600 font-pixel w-full hover:text-white" href="#">Gitbook</a>
                        </div>
                        <div className="w-36 flex flex-col justify-start">
                            <span className="block w-full text-zinc-400 f font-header text-lg">Other</span>
